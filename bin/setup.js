...
const routes = [
  ...
  {
    name: "storeById",
    path: ["src", "app", "api", "stores", "[id]"],
    handler: "erp-core/stores",
    methods: ["GET"],
    exportName: "GetStoreByIdGET",
  ...
  },
  {
    ...
    description: "Activate item collections by filter",
  },
  {
    ...
    description: "Deactivate item collections by filter",
  },
  {
  ...
  {
    name: "copyParentToChildStores",
    path: ["src", "app", "api", "items", "copy-parent-to-child-stores"],
    handler: "erp-core/inventory/items",
    methods: ["POST"],
    exportName: "CopyParentToChildStoresPOST",
    description: "Copy parent store items to multiple child stores",
  },
  {
    name: "copyToStore",
    path: ["src", "app", "api", "items", "copy-to-store", "[childStoreId]"],
    handler: "erp-core/inventory/items",
    methods: ["POST"],
    exportName: "CopyToStorePOST",
    description: "Copy items to a specific child store",
  },
  {
    ...
    description: "Sync parent store data to child store for an item",
  },
  {
    name: "offersPaging",
