...
export { GET as GetItemFeaturesGET } from "./handler/getItemFeatures";
...
export * from "./putItemCollection";
export * from "./putItemCollectionActivate";
export * from "./putItemCollectionDeactivate";
...
export { PUT as PutItemCollectionPUT } from "./handler/putItemCollection";
export { PUT as PutItemCollectionActivatePUT } from "./handler/putItemCollectionActivate";
export { PUT as PutItemCollectionDeactivatePUT } from "./handler/putItemCollectionDeactivate";
