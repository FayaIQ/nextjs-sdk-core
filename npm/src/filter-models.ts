...
// Add all filter parameters
        ...
        if (this.name !== null && this.name.trim() !== '') map.name = this.name.trim();
        ...
        if (this.minDiscountPercentage !== null) map.minDiscountPercentage = this.minDiscountPercentage;
        return map;
    }
    /**
    ...
    static fromURLSearchParams(params: URLSearchParams): ItemsFilterParameters {
        ...
        return new ItemsFilterParameters({
            ...
            gender: params.get('gender') ? parseInt(params.get('gender')!) as Gender : null,
            age: params.get('age') ? parseInt(params.get('age')!) as AgeGroup : null,
