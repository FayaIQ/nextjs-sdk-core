...
async function deleteOffer(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-VGCQIDM6.js");
    const { Api } = await import("../../api-UEHYIAOC.js");
...
async function postOffersItemsDiscount(payload) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-VGCQIDM6.js");
    const { Api } = await import("../../api-UEHYIAOC.js");
...
async function putOffersItemsDiscount(id, payload) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-VGCQIDM6.js");
    const { Api } = await import("../../api-UEHYIAOC.js");
