...
} from "../../chunk-SOBIHKN5.js";
import "../../chunk-DXJNGSNT.js";
...
async function deleteOffer(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-O2HMJ75M.js");
    const { Api } = await import("../../api-IWWKU55Q.js");
...
async function postOffersItemsDiscount(payload) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-O2HMJ75M.js");
    const { Api } = await import("../../api-IWWKU55Q.js");
...
async function putOffersItemsDiscount(id, payload) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-O2HMJ75M.js");
    const { Api } = await import("../../api-IWWKU55Q.js");
