...
} from "../../chunk-JKJF3F23.js";
import "../../chunk-DPG6VFP2.js";
import "../../chunk-QGIRUB4D.js";
...
async function deleteOffer(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-HKQGA2FY.js");
    const { Api } = await import("../../api-2XXZYWI5.js");
...
async function getInvoiceDiscount(coupon) {
  if (typeof window === "undefined") {
    const { getWithoutAuth } = await import("../../fetcher-HKQGA2FY.js");
    const { Api } = await import("../../api-2XXZYWI5.js");
...
async function postOffersItemsDiscount(payload) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-HKQGA2FY.js");
    const { Api } = await import("../../api-2XXZYWI5.js");
...
async function putOffersItemsDiscount(id, payload) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-HKQGA2FY.js");
    const { Api } = await import("../../api-2XXZYWI5.js");
