...
} from "../../chunk-QCO4JZ4J.js";
import "../../chunk-5MUZR4S6.js";
...
async function deleteOffer(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-R4TTH3KN.js");
    const { Api } = await import("../../api-IWWKU55Q.js");
...
async function postOffersItemsDiscount(payload) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-R4TTH3KN.js");
    const { Api } = await import("../../api-IWWKU55Q.js");
...
async function putOffersItemsDiscount(id, payload) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-R4TTH3KN.js");
    const { Api } = await import("../../api-IWWKU55Q.js");
...
export {
  ...
  GET8 as GetOffersDeliveryZonesGET,
  GET9 as GetOffersGroupsGET,
