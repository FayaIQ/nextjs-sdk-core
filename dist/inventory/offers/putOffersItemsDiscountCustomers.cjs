...
var putOffersItemsDiscountCustomers_exports = {};
__export(putOffersItemsDiscountCustomers_exports, {
  putOffersItemsDiscountCustomers: () => putOffersItemsDiscountCustomers
});
module.exports = __toCommonJS(putOffersItemsDiscountCustomers_exports);
