...
async function getProductInfoV2(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-HF5W5PJ3.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-HF5W5PJ3.js");
    const { Api: Api2 } = await import("../../api-HF64SQC2.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-HF5W5PJ3.js");
    const { Api: Api2 } = await import("../../api-HF64SQC2.js");
