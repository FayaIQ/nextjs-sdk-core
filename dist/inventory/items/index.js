...
async function getItemById(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-STP4FF3T.js");
    const { Api: Api2 } = await import("../../api-2XXZYWI5.js");
...
async function postCopyParentStore(itemIds) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-STP4FF3T.js");
    const { Api: Api2 } = await import("../../api-2XXZYWI5.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-STP4FF3T.js");
    const { Api: Api2 } = await import("../../api-2XXZYWI5.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-STP4FF3T.js");
    const { Api: Api2 } = await import("../../api-2XXZYWI5.js");
