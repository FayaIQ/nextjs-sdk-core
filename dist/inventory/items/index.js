...
import {
  Api
} from "../../chunk-CK36K5WK.js";
import {
  getWithAuth
} from "../../chunk-AXTX3LZI.js";
import "../../chunk-ROYJHVLJ.js";

// src/inventory/items/getProductInfoV2.ts
async function getProductInfoV2(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-ZET5K2UJ.js");
    const { Api: Api2 } = await import("../../api-HI3ED3LJ.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-ZET5K2UJ.js");
    const { Api: Api2 } = await import("../../api-HI3ED3LJ.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-ZET5K2UJ.js");
    const { Api: Api2 } = await import("../../api-HI3ED3LJ.js");
