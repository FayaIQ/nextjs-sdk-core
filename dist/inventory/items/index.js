...
async function getProductInfoV2(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-CX4XI7JJ.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-CX4XI7JJ.js");
    const { Api: Api2 } = await import("../../api-VEZZ6GU2.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-CX4XI7JJ.js");
    const { Api: Api2 } = await import("../../api-VEZZ6GU2.js");
