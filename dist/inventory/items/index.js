...
async function getProductInfoV2(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-UBKYMKSK.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-UBKYMKSK.js");
    const { Api: Api2 } = await import("../../api-IZXQRBVZ.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-UBKYMKSK.js");
    const { Api: Api2 } = await import("../../api-IZXQRBVZ.js");
