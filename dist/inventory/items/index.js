...
async function getItemById(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-OYBMXYXN.js");
    const { Api: Api2 } = await import("../../api-RHFGMX5X.js");
...
async function postCopyParentStore(itemIds) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-OYBMXYXN.js");
    const { Api: Api2 } = await import("../../api-RHFGMX5X.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-OYBMXYXN.js");
    const { Api: Api2 } = await import("../../api-RHFGMX5X.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-OYBMXYXN.js");
    const { Api: Api2 } = await import("../../api-RHFGMX5X.js");
