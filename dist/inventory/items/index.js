...
async function getProductInfoV2(id) {
  if (typeof window === "undefined") {
    const { getWithAuth: getWithAuth2 } = await import("../../fetcher-KXJP7QMF.js");
...
async function postCopyParentStore(itemIds) {
  if (typeof window === "undefined") {
    const { postWithAuth } = await import("../../fetcher-KXJP7QMF.js");
    const { Api: Api2 } = await import("../../api-QG2WVXL6.js");
...
async function putActivateItem(id) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("../../fetcher-KXJP7QMF.js");
    const { Api: Api2 } = await import("../../api-QG2WVXL6.js");
...
async function deleteItem(id) {
  if (typeof window === "undefined") {
    const { deleteWithAuth } = await import("../../fetcher-KXJP7QMF.js");
    const { Api: Api2 } = await import("../../api-QG2WVXL6.js");
