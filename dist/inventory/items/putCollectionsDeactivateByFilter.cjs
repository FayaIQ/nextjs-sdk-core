...
var putCollectionsDeactivateByFilter_exports = {};
__export(putCollectionsDeactivateByFilter_exports, {
  putCollectionsDeactivateByFilter: () => putCollectionsDeactivateByFilter
});
module.exports = __toCommonJS(putCollectionsDeactivateByFilter_exports);
init_api();
