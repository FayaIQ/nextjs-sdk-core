...
var getItemsPaging_exports = {};
__export(getItemsPaging_exports, {
  GET: () => GET
});
module.exports = __toCommonJS(getItemsPaging_exports);
...
async function GET(request) {
  try {
    ...
    return import_server2.NextResponse.json(data, { status: 200 });
  } catch (error) {
