...
__export(items_exports, {
  ...
  Gender: () => Gender,
  GetItemByIdGET: () => GET6,
  GetItemsPagingGET: () => GET5,
  GetParentProductsGET: () => GET4,
  GetProductsGET: () => GET,
...
async function getProducts({
  ...
  if (typeof window === "undefined") {
    ...
    const { Api: Api2 } = await Promise.resolve().then(() => (init_api(), api_exports));
    console.log("Server-side filter params:", `${Api2.getProducts}?${params.toString()}`);
    return getWithAuth2(
...
async function GET3(request, { params }) {
  try {
    ...
    return import_server4.NextResponse.json(product);
  } catch (error) {
    return toNextResponseFromError(error);
  }
}
...
async function GET4(request) {
  try {
    ...
    return import_server5.NextResponse.json(products);
  } catch (error) {
    return toNextResponseFromError(error);
  }
}
...
async function GET5(request) {
  try {
    ...
    return import_server6.NextResponse.json(data, { status: 200 });
  } catch (error) {
    return toNextResponseFromError(error);
  }
}
...
async function POST(request) {
  try {
    ...
    if (!itemIds) {
      return import_server8.NextResponse.json({ error: "itemIds array is required" }, { status: 400 });
    }
...
async function putCollectionsActivateByFilter(payload) {
  if (typeof window === "undefined") {
    const { putWithAuth: putWithAuth2 } = await Promise.resolve().then(() => (init_fetcher(), fetcher_exports));
    return putWithAuth2(Api.putItemsCollectionsActivateByFilter(), payload);
  }
...
async function putCollectionsDeactivateByFilter(payload) {
  if (typeof window === "undefined") {
    const { putWithAuth: putWithAuth2 } = await Promise.resolve().then(() => (init_fetcher(), fetcher_exports));
    return putWithAuth2(Api.putItemsCollectionsDeactivateByFilter(), payload);
  }
