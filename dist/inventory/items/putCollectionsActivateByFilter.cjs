...
var putCollectionsActivateByFilter_exports = {};
__export(putCollectionsActivateByFilter_exports, {
  putCollectionsActivateByFilter: () => putCollectionsActivateByFilter
});
module.exports = __toCommonJS(putCollectionsActivateByFilter_exports);
init_api();
