...
var postClient_exports = {};
__export(postClient_exports, {
  POST: () => POST
});
module.exports = __toCommonJS(postClient_exports);
...
async function POST(request) {
  try {
    ...
    return import_server2.NextResponse.json(client, { status: 201 });
  } catch (err) {
