...
var getAddressById_exports = {};
__export(getAddressById_exports, {
  GET: () => GET
});
module.exports = __toCommonJS(getAddressById_exports);
...
async function GET(request) {
  try {
    ...
    return import_server2.NextResponse.json(address);
  } catch (err) {
