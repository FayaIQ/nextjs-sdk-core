import {
  ...
  setEncryptedCookie,
  setPlainCookie
} from "./chunk-CFGJZORH.js";
import {
  apiFetch
} from "./chunk-VFW362FW.js";
import {
  getToken
...
async function getStoreInfo() {
  if (typeof window === "undefined") {
    const { getWithAuth } = await import("./core-6EPTFWPM.js");
...
async function getProducts({
  ...
  if (typeof window === "undefined") {
    const { getWithAuth } = await import("./fetcher-MUTJ5I57.js");
    const { Api: Api2 } = await import("./api-IWWKU55Q.js");
    console.log(
...
async function getOrders({
  ...
  if (typeof window === "undefined") {
    const { getWithAuth } = await import("./fetcher-MUTJ5I57.js");
    const { default: getToken2 } = await import("./token-PJU2YZX3.js");
    const { Api: Api2 } = await import("./api-IWWKU55Q.js");
...
async function putItemCollection(id, collectionId, data) {
  if (typeof window === "undefined") {
    const { putWithAuth } = await import("./fetcher-MUTJ5I57.js");
    const { Api: Api2 } = await import("./api-IWWKU55Q.js");
