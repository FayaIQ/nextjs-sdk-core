 ...
 */
declare function getWithAuth<T>(url: string, query?: QueryParams, headers?: Record<string, string>, nextOptions?: {
    revalidate?: number;
    tags?: string[];
    cache?: RequestCache | "force-cache" | "no-store";
}): Promise<T>;
 ...
 */
declare function getWithoutAuth<T>(url: string, query?: QueryParams, headers?: Record<string, string>, nextOptions?: {
    revalidate?: number;
    tags?: string[];
    cache?: RequestCache | "force-cache" | "no-store";
}): Promise<T>;
